...
public class AllProductAdapter2 extends CursorAdapter {
    private Context Context1;



    public AllProductAdapter2(Context context, Cursor c) {
        super(context, c, 0);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        return LayoutInflater.from(context).inflate(R.layout.stok_bilgi_item, viewGroup, false);
    }
